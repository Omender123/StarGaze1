...
public class EventAdapter extends RecyclerView.Adapter<EventAdapter.EventViewHolder> {
    ...
    public EventAdapter(List<EventResp.Event> data, Context context, OnEventItemListener listener) {
        this.data = data;
...
//        holder.img_thumbnail.setImageResource(R.drawable.concert3);
       ...
       holder.itemView.setOnClickListener(new View.OnClickListener() {
           ...
           public void onClick(View view) {
               listener.onEventItemClick(data,position);
           }
       });
    }
...
//            event_price = itemView.findViewById(R.id.event_price);
    ...
    public interface OnEventItemListener{
        void onEventItemClick(List<EventResp.Event>data, int position);
    }
